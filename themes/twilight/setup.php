<?php
	...
	setPageTitle("PARLEY! - Simple Forum setup");
	...
	if(!isSet($_POST['setup']))
	{
			...
			<hr /><br />
			<h2>Welcome to PARLEY! - Simple Forum!</h2><br />
			<br />
...
EOT;
		...
		{
			addToBody("Your server has one more issues that makes it imcompatible with PARLEY! - Simple Forum.");
			finishPage();
		}
	}
		...
		if(!isSet($_POST['server_addr']))
		{
			...
			<div style="text-align: left; width: 75%">
				<form method="POST">
					...
					<tr><td>Forum name/Site name:<span class="rightAlign"><input type="text" name="sitename" value="PARLEY! - Simple Forum" required/></span></td><td class="finetext">This will show up in the brower's title bar when visiting the home page.</td></tr>
